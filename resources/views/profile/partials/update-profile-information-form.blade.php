<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <textarea id="alamat" name="alamat" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" autocomplete="street-address">{{ old('alamat', $user->alamat) }}</textarea>
            <p class="mt-1 text-xs text-gray-500">Dipakai sebagai alamat pada surat/dokumen resmi hasil layanan.</p>
