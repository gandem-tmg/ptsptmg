                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.layanan.update', $layanan) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="kode_layanan" id="kode_layanan" value="{{ old('kode_layanan', $layanan->kode_layanan) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500" required>
                            @error('kode_layanan')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_layanan" id="nama_layanan" value="{{ old('nama_layanan', $layanan->nama_layanan) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500" required>
                            @error('nama_layanan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="seksi_id" id="seksi_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500" required>
                                ...
                                @foreach($seksis as $seksi)
                                    <option value="{{ $seksi->id }}" {{ old('seksi_id', $layanan->seksi_id) == $seksi->id ? 'selected' : '' }}>{{ $seksi->nama_seksi }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('deskripsi', $layanan->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

                        <x-klasifikasi-fieldset :layanan="$layanan" />
                        ...
                        <div class="mb-6 rounded-lg border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    ...
                                    <textarea name="sistem_mekanisme_prosedur" id="sistem_mekanisme_prosedur" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('sistem_mekanisme_prosedur', $layanan->sistem_mekanisme_prosedur) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea name="jangka_waktu_pelayanan" id="jangka_waktu_pelayanan" rows="2" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('jangka_waktu_pelayanan', $layanan->jangka_waktu_pelayanan) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea name="biaya_tarif" id="biaya_tarif" rows="2" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('biaya_tarif', $layanan->biaya_tarif) }}</textarea>
                                    @error('biaya_tarif')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <textarea name="produk_pelayanan" id="produk_pelayanan" rows="2" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500">{{ old('produk_pelayanan', $layanan->produk_pelayanan) }}</textarea>
