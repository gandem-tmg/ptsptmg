                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.layanan.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="kode_layanan" id="kode_layanan" value="{{ old('kode_layanan') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                            @error('kode_layanan')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_layanan" id="nama_layanan" value="{{ old('nama_layanan') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
                            @error('nama_layanan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
