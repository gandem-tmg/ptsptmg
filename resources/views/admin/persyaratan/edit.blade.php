                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.persyaratan.update', $persyaratan) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="deskripsi" name="deskripsi" class="mt-1 block w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm" rows="4">{{ old('deskripsi', $persyaratan->deskripsi) }}</textarea>
