<x-public-layout>
    <div class="mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        @else
            <form method="POST" action="{{ route('guest.survei.perTiket.store', $permohonan->no_tiket) }}" class="mt-5 space-y-3">
                @csrf
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('guest.trackTicket', $permohonan->no_tiket) }}" class="text-sm font-semibold text-emerald-700 hover:text-emerald-800">
                &larr; Kembali ke Status Permohonan
            </a>
        </div>
    </div>
</x-public-layout>
