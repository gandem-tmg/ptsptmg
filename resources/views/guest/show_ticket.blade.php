        ...
        <div class="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            ...
            <dl class="grid grid-cols-1 gap-2.5 p-4 sm:grid-cols-2">
                <div class="flex items-start gap-3 rounded-lg bg-slate-50 p-3">
                    <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white text-slate-400 shadow-sm">
                ...
                <div class="flex items-start gap-3 rounded-lg bg-slate-50 p-3">
                    ...
                    <div class="min-w-0">
                        <dt class="text-xs font-medium text-slate-500">Tanggal Pengajuan</dt>
                ...
                <div class="flex items-start gap-3 rounded-lg bg-slate-50 p-3 sm:col-span-2">
                    ...
                    <div class="min-w-0">
                        <dt class="text-xs font-medium text-slate-500">Sedang Ditangani</dt>
