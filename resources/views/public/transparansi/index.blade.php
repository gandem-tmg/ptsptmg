    ...
    <div class="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-5">
            <div class="soft-card p-5">
                ...
                <p class="text-xs text-slate-600">Total Permohonan</p>
                <p class="mt-0.5 text-2xl font-bold text-slate-900">{{ number_format($totalKeseluruhan, 0, ',', '.') }}</p>
                <p class="mt-0.5 text-[11px] text-slate-500">Sejak sistem berjalan</p>
            </div>
            ...
            <div class="soft-card p-5">
                ...
                <p class="text-xs text-slate-600">Permohonan Bulan Ini</p>
                <p class="mt-0.5 text-2xl font-bold text-slate-900">{{ number_format($totalBulanIni, 0, ',', '.') }}</p>
                <p class="mt-0.5 text-[11px] text-slate-500">{{ now()->translatedFormat('F Y') }}</p>
            </div>
            ...
            <div class="soft-card p-5">
                ...
                <p class="text-xs text-slate-600">Selesai Bulan Ini</p>
                <p class="mt-0.5 text-2xl font-bold text-emerald-600">{{ number_format($totalSelesaiBulanIni, 0, ',', '.') }}</p>
                <p class="mt-0.5 text-[11px] text-slate-500">dari {{ number_format($totalBulanIni, 0, ',', '.') }} pengajuan</p>
            </div>
            ...
            <div class="soft-card p-5">
                ...
                <p class="text-xs text-slate-600">Layanan Tersedia</p>
                <p class="mt-0.5 text-2xl font-bold text-slate-900">{{ $totalLayanan }}</p>
                <p class="mt-0.5 text-[11px] text-slate-500">Jenis layanan aktif</p>
            </div>
            ...
            <div class="soft-card col-span-2 flex items-center gap-4 p-5 lg:col-span-1">
                ...
                <div class="min-w-0">
                    <p class="text-xs text-slate-600">Tingkat Penyelesaian</p>
                    <p class="mt-0.5 text-[11px] leading-snug text-slate-500">Dari permohonan yang sudah final (selesai/ditolak/dibatalkan)</p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-5">
            <div class="soft-card p-5 sm:p-6 lg:col-span-3">
                ...
                <p class="mb-4 text-sm text-slate-600">Jumlah permohonan masuk, 6 bulan terakhir</p>
            ...
            <div class="soft-card p-5 sm:p-6 lg:col-span-2">
                ...
                <p class="mb-4 text-sm text-slate-600">Dari {{ number_format($totalKeseluruhan, 0, ',', '.') }} permohonan sejak awal</p>
        ...
        <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-5">
            <div class="soft-card p-5 sm:p-6 lg:col-span-3">
                ...
                <p class="mb-4 text-sm text-slate-600">Enam layanan dengan jumlah permohonan terbanyak</p>
                @if($layananTerpopuler->isEmpty())
                    <p class="text-sm text-slate-500">Belum ada data yang cukup untuk ditampilkan.</p>
                @else
                    <div class="mx-auto">
            ...
            <div class="soft-card p-5 sm:p-6 lg:col-span-2">
                ...
                <p class="mb-4 text-sm text-slate-600">Datang langsung ke loket vs. lewat akun online</p>
                <div class="mx-auto max-w-[220px]">
        ...
        <div class="mt-6 soft-card p-5 sm:p-6">
            ...
            <p class="mb-5 text-sm text-slate-600">Dihitung dari tanggal pengajuan sampai layanan dinyatakan selesai (hari)</p>
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 bg-gradient-to-r from-emerald-50 to-teal-50 p-5 sm:p-6">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-600">Pengisian &amp; hasil SKM sekarang dikelola lewat satu sistem resmi, supaya datanya tidak tercecer di beberapa tempat.</p>
                    </div>
                </div>
