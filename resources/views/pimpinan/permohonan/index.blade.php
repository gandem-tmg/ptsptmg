<x-app-layout>
    ...
    <div class="space-y-4 py-2">
        <form method="GET" action="{{ route('pimpinan.permohonan.index') }}" class="filter-toolbar">
        ...
        @else
            <x-data-table>
                ...
                <tbody>
                    ...
                    <tr class="row-clickable" onclick="location.href='{{ route('pimpinan.permohonan.show', $permohonan) }}'">
                        ...
                        <td class="text-right" onclick="event.stopPropagation()">
                            <a href="{{ route('pimpinan.permohonan.show', $permohonan) }}" title="Lihat" class="icon-action icon-action-view">
