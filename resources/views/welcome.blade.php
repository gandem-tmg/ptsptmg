        ...
        <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
            ...
            <div class="mt-8 grid gap-6 md:grid-cols-3">
                <div class="soft-card p-5">
                    ...
                    <p class="mt-2 text-sm leading-6 text-slate-600">Masuk dengan akun Anda atau daftar tanpa akun untuk mengajukan permohonan baru dengan mudah.</p>
                    <a href="{{ route('login') }}" class="mt-5 inline-flex text-sm font-semibold text-emerald-600 hover:text-emerald-700">Masuk &amp; Ajukan →</a>
                </div>
                ...
                <div class="soft-card p-5">
                    ...
                    <p class="mt-2 text-sm leading-6 text-slate-600">Isi biodata dan unggah dokumen persyaratan tanpa harus masuk terlebih dahulu.</p>
